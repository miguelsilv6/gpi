...
- **Toolbox OSINT** — IP lookup, DNS, WHOIS/RDAP, cabeçalhos de email, defang de IOCs, dígito de controlo IMEI, pesquisa de username (70+ plataformas), pesquisa de email (SMTP, reputação, infostealers, breaches, Gravatar, dorks, domínio) — exportável em Markdown/Excel/PDF
