  ...
  try {
    ...
    const produto = await prisma.intercecaoProduto.create({
      data: {
        ...
        idProduto: d.idProduto ?? null,
        transcricao: d.transcricao ?? 'NENHUMA',
        transcricaoEm: d.transcricao && d.transcricao !== 'NENHUMA' ? new Date() : null,
        de: d.de ?? null,
        identificacaoDe: d.identificacaoDe ?? null,
        para: d.para ?? null,
        identificacaoPara: d.identificacaoPara ?? null,
        resumo: d.resumo,
