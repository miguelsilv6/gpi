...
const schema = z.object({
  ...
  moduloToolboxAtivo: z.boolean().optional(),
  moduloToolboxRoles: z.string().optional(),
  moduloAnexosAtivo: z.boolean().optional(),
  moduloAnexosRoles: z.string().optional(),
  moduloAgendaAtivo: z.boolean().optional(),
  moduloAgendaRoles: z.string().optional(),
  moduloIntercecoesAtivo: z.boolean().optional(),
  moduloIntercecoesRoles: z.string().optional(),
  moduloApreensoesAtivo: z.boolean().optional(),
  moduloApreensoesRoles: z.string().optional(),
  apreensaoAlertaDias: z.number().int().min(0).max(3650).nullable().optional(),
  moduloPericiasAtivo: z.boolean().optional(),
  moduloPericiasRoles: z.string().optional(),
  toolboxIaAtivo: z.boolean().optional(),
  toolboxIaModelo: z.string().min(1).max(100).optional(),
  emailNotificacoesAtivo: z.boolean().optional(),
      ...
      ? diff(
          {
            ...
            moduloToolboxAtivo: before.moduloToolboxAtivo,
            moduloToolboxRoles: before.moduloToolboxRoles,
            moduloAnexosAtivo: before.moduloAnexosAtivo,
            moduloAnexosRoles: before.moduloAnexosRoles,
            moduloAgendaAtivo: before.moduloAgendaAtivo,
            moduloAgendaRoles: before.moduloAgendaRoles,
            moduloIntercecoesAtivo: before.moduloIntercecoesAtivo,
            moduloIntercecoesRoles: before.moduloIntercecoesRoles,
            moduloApreensoesAtivo: before.moduloApreensoesAtivo,
            moduloApreensoesRoles: before.moduloApreensoesRoles,
            apreensaoAlertaDias: before.apreensaoAlertaDias,
            moduloPericiasAtivo: before.moduloPericiasAtivo,
            moduloPericiasRoles: before.moduloPericiasRoles,
            toolboxIaAtivo: before.toolboxIaAtivo,
            toolboxIaModelo: before.toolboxIaModelo,
            emailNotificacoesAtivo: before.emailNotificacoesAtivo,
          ...
          },
          {
            ...
            moduloToolboxAtivo: config.moduloToolboxAtivo,
            moduloToolboxRoles: config.moduloToolboxRoles,
            moduloAnexosAtivo: config.moduloAnexosAtivo,
            moduloAnexosRoles: config.moduloAnexosRoles,
            moduloAgendaAtivo: config.moduloAgendaAtivo,
            moduloAgendaRoles: config.moduloAgendaRoles,
            moduloIntercecoesAtivo: config.moduloIntercecoesAtivo,
            moduloIntercecoesRoles: config.moduloIntercecoesRoles,
            moduloApreensoesAtivo: config.moduloApreensoesAtivo,
            moduloApreensoesRoles: config.moduloApreensoesRoles,
            apreensaoAlertaDias: config.apreensaoAlertaDias,
            moduloPericiasAtivo: config.moduloPericiasAtivo,
            moduloPericiasRoles: config.moduloPericiasRoles,
            toolboxIaAtivo: config.toolboxIaAtivo,
            toolboxIaModelo: config.toolboxIaModelo,
          ...
          [
            ...
            'moduloIntercecoesRoles',
            'moduloApreensoesAtivo',
            'moduloApreensoesRoles',
            'apreensaoAlertaDias',
            'moduloPericiasAtivo',
            'moduloPericiasRoles',
            'toolboxIaAtivo',
            'toolboxIaModelo',
            'emailNotificacoesAtivo',
