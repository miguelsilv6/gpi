...
export const ACAO_LABELS: Record<string, string> = {
  ...
  CREATE_INTERCECAO_PLANO: 'Plano de validações de interceções criado',
  UPDATE_INTERCECAO_PLANO: 'Plano de validações de interceções alterado',
  DELETE_INTERCECAO_PLANO: 'Plano de validações de interceções eliminado',
  MARCAR_INTERCECAO_VALIDACAO: 'Validação de interceções marcada como feita',
  DESMARCAR_INTERCECAO_VALIDACAO: 'Validação de interceções desmarcada',
  CREATE_INTERCECAO_RELACAO: 'Relação de interceção fichada',
  UPDATE_INTERCECAO_RELACAO: 'Relação de interceção alterada',
  DELETE_INTERCECAO_RELACAO: 'Relação de interceção eliminada',
  UPLOAD_INTERCECAO_RELACAO_FOTO: 'Foto de relação de interceção carregada',
  DELETE_INTERCECAO_RELACAO_FOTO: 'Foto de relação de interceção removida',
  CREATE_INTERCECAO_OUVIDO_ATE: '"Ouvido até" registado',
...
export const FIELD_LABELS: Record<string, string> = {
  ...
  horaFim: 'Hora de fim',
  de: 'De',
  identificacaoDe: 'Identificação do "De"',
  para: 'Para',
  identificacaoPara: 'Identificação do "Para"',
  resumo: 'Resumo',
  ...
  // Validações quinzenais, relações e "ouvido até".
  // `numero`, `alertaDias`, `documento`, `morada` e `contacto` já estão
  // mapeados acima (controlos e intervenientes) — os labels servem os dois.
  dataPrimeira: 'Data da 1.ª validação',
  intervaloDias: 'Intervalo (dias)',
  validacoes: 'Validações',
  fichaSpo: 'Ficha no SPO',
  dataNascimento: 'Data de nascimento',
  substituiu: 'Substituiu a anterior',
