...
export const queryInspetores: RelatorioHandler = async (filters, session) => {
  ...
  return {
    ...
    columns: [
      { key: 'inspetor', label: 'Inspetor', flex: 1.6 },
      { key: 'brigada', label: 'Brigada', flex: 1.3 },
      { key: 'atribuidosPeriodo', label: 'Atribuídos no período', align: 'right', flex: 0.7 },
      { key: 'concluidosPeriodo', label: 'Concluídos no período', align: 'right', flex: 0.7 },
      { key: 'ativosHoje', label: 'Ativos hoje', align: 'right', flex: 0.65 },
      { key: 'atividades', label: 'Atividades realizadas', align: 'right', flex: 0.65 },
      { key: 'atividadesPonderado', label: 'Atividades × quantidade', align: 'right', flex: 0.7 },
    ],
    rows,
